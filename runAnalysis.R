##########################################################################################################
# This script cleans and reorganises the the UCI HAR Dataset as follows:
#
# 1. Merges the training and the test sets to create a new data set
# 2. Extracts only the measurements for the mean and standard deviation for each variable in the new data set
# 3. Uses descriptive activity names to name the activities in the data set
# 4. Appropriately labels the data set with descriptive names for variables 
...
setwd('D:/R-Programming/CleaningData/UCI HAR Dataset/');
